function mainTest(tree, index_cm) {
  ...
  test(() => {
    ...
    assert_true(tree.TEMPLATE_LEAF_EXPANDED_BTN instanceof DocumentFragment);
    assert_true(tree.TEMPLATE_LEAF_COLLAPSED_BTN instanceof DocumentFragment);
    assert_true(tree.TEMPLATE_LEAF_SPLASH instanceof DocumentFragment);
